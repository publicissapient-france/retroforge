...
export default function SelectCard({ question, onSelected }: SelectCardProp) {
  ...
  return (
    <motion.div
      ...
      style={{ x, opacity }}
      className="rounded-[15px] lg:w-[800px] sm:w-[550px] max-sm:w-[300px] m-auto border border-[#EEEEEE] box-border p-[40px] shadow-[0_2px_8px_-4px_rgba(0,0,0,0.2)] uppercase"
    >
