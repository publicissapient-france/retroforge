...
export default function SwipeAction({ type, onClick }: SwipeActionProps) {
  ...
  return (
    <button className="flex justify-center items-center rounded-full cursor-pointer max-md:w-[60px] max-md:h-[60px] md:w-[80px] md:h-[80px] border border-[#d8d8d8] hover:bg-[#fafafa]" onClick={() => onClick(type)}>
